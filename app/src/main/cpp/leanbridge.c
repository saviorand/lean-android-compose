...
extern lean_object * initialize_lean_x2dcompose_Compose_Demo(uint8_t builtin);
...
static int ensure_init(void) {
  ...
  lean_object *res = initialize_Init(1);
  ...
  lean_object *ui = initialize_lean_x2dcompose_Compose_Demo(1);
